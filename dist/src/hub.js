...
function massPingHubFromProxies(rn) {
    ...
    const nodes = [];
    await;
    asyncForEach(owners, async(o, Contact), {
        const: proxyNodeInfo = await, proxynodeinfo(o, publicKey) { },
        const: clean = o.authToken === null || o.authToken === "",
        nodes: .push({}, ...proxyNodeInfo, clean, last_active, o.lastActive, route_hint, o.routeHint, relay_commit, rn.relay_commit, lnd_version, rn.lnd_version, relay_version, rn.relay_version, testnet, rn.testnet, ip, rn.ip, public_ip, rn.public_ip, node_alias, rn.node_alias)
    });
}
;
...
export { pingHubInterval, checkInvitesHubInterval, sendHubCall, sendNotification, createInviteInHub, finishInviteInHub, payInviteInHub, payInviteInvoice };
async;
