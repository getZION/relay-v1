...
*/
const sendAttachmentMessage = (req, res) =>
...
const purchase = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    network.sendMessage({
      chat: Object.assign(Object.assign({}, chat.dataValues), {
...
const receivePurchase = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const {
      ...
      purchaser_id,
      network_type,
    } = yield helpers.parseReceiveParams(payload);
...
const receivePurchaseAccept = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const receivePurchaseDeny = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const receiveAttachment = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    confirmations_1.sendConfirmation({
      chat,
      sender: owner,
      msg_id,
      receiver: sender,
...
function signer(req, res) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const sig = yield lightning_1.signBuffer(
...
function cycleMediaToken() {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      if (process.env.TEST_LDAT) ldat_1.testLDAT();
